...
class MLP(nn.Module):
    ...
    def check_metrics(self)-> bool:
        ...
        curr_rec = float(os.getenv('MLP_RECALL'))
    ...
    def save_metrics(self):
        ...
        os.environ['MLP_VALIDATION_ACCURY'] = str(self.validation_accuracy)
        ...
        os.environ['MLP_SPECIFICITY'] = str(self.specificity)
        os.environ['MLP_PRECISION'] = str(self.precision)
        os.environ['MLP_RECALL'] = str(self.recall)
        os.environ['MLP_F1'] = str(self.f1)
        os.environ['MLP_MCC'] = str(self.mcc)
        ...
        dotenv.set_key(env_file, 'MLP_VALIDATION_ACCURACY', os.environ['MLP_VALIDATION_ACCURY'])
        ...
        dotenv.set_key(env_file, 'MLP_SPECIFICITY', os.environ['MLP_SPECIFICITY'])
        dotenv.set_key(env_file, 'MLP_PRECISION', os.environ['MLP_PRECISION'])
        dotenv.set_key(env_file, 'MLP_RECALL', os.environ['MLP_RECALL'])
        dotenv.set_key(env_file, 'MLP_F1', os.environ['MLP_F1'])
